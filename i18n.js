...
window.I18N = {
  ko: {
    ...
    'dg.sub':'여러 도형과 화살표로 도식을 그려 SVG·PNG로 저장합니다.','dg.add':'＋ 상자 추가','dg.connect':'🔗 연결 모드','dg.del':'🗑 선택 삭제','dg.hint':'상자·화살표를 클릭해 선택 · 드래그로 이동 · 더블클릭으로 글자 수정 · 연결 모드에서 두 상자를 차례로 클릭','dg.dlsvg':'⬇️ SVG 저장','dg.dlpng':'⬇️ PNG 저장','dg.editprompt':'상자 텍스트','dg.box':'상자','dg.start':'시작','dg.process':'처리','dg.decision':'판단','dg.shape':'도형','dg.s.round':'둥근 사각형','dg.s.rect':'사각형','dg.s.ellipse':'타원','dg.s.diamond':'마름모(판단)','dg.s.parallel':'평행사변형','dg.s.cylinder':'원통(DB)','dg.line':'선','dg.l.solid':'실선','dg.l.dashed':'점선','dg.arrow':'화살표','dg.a.end':'끝 화살표','dg.a.both':'양방향','dg.a.none':'없음'
  },
  en: {
    ...
    'dg.sub':'Draw shapes & arrows and export as SVG/PNG.','dg.add':'＋ Add box','dg.connect':'🔗 Connect mode','dg.del':'🗑 Delete selected','dg.hint':'Click a box/arrow to select · drag to move · double-click to edit · in connect mode click two boxes','dg.dlsvg':'⬇️ Save SVG','dg.dlpng':'⬇️ Save PNG','dg.editprompt':'Box text','dg.box':'Box','dg.start':'Start','dg.process':'Process','dg.decision':'Decision','dg.shape':'Shape','dg.s.round':'Rounded','dg.s.rect':'Rectangle','dg.s.ellipse':'Ellipse','dg.s.diamond':'Diamond','dg.s.parallel':'Parallelogram','dg.s.cylinder':'Cylinder (DB)','dg.line':'Line','dg.l.solid':'Solid','dg.l.dashed':'Dashed','dg.arrow':'Arrow','dg.a.end':'End','dg.a.both':'Both','dg.a.none':'None'
  },
  zh: {
    ...
    'dg.sub':'用多种图形和箭头绘制图示并导出 SVG/PNG。','dg.add':'＋ 添加方框','dg.connect':'🔗 连接模式','dg.del':'🗑 删除所选','dg.hint':'点击方框/箭头选择 · 拖动移动 · 双击编辑文字 · 连接模式下依次点击两个方框','dg.dlsvg':'⬇️ 保存 SVG','dg.dlpng':'⬇️ 保存 PNG','dg.editprompt':'方框文字','dg.box':'方框','dg.start':'开始','dg.process':'处理','dg.decision':'判断','dg.shape':'形状','dg.s.round':'圆角矩形','dg.s.rect':'矩形','dg.s.ellipse':'椭圆','dg.s.diamond':'菱形(判断)','dg.s.parallel':'平行四边形','dg.s.cylinder':'圆柱(DB)','dg.line':'线条','dg.l.solid':'实线','dg.l.dashed':'虚线','dg.arrow':'箭头','dg.a.end':'末端','dg.a.both':'双向','dg.a.none':'无'
  },
  ja: {
    ...
    'dg.sub':'図形と矢印で図を描き、SVG/PNG で保存します。','dg.add':'＋ 四角を追加','dg.connect':'🔗 連結モード','dg.del':'🗑 選択を削除','dg.hint':'ボックス/矢印をクリックで選択 · ドラッグで移動 · ダブルクリックで文字編集 · 連結モードで2つを順にクリック','dg.dlsvg':'⬇️ SVG 保存','dg.dlpng':'⬇️ PNG 保存','dg.editprompt':'四角のテキスト','dg.box':'四角','dg.start':'開始','dg.process':'処理','dg.decision':'判断','dg.shape':'図形','dg.s.round':'角丸四角','dg.s.rect':'四角形','dg.s.ellipse':'楕円','dg.s.diamond':'ひし形(判断)','dg.s.parallel':'平行四辺形','dg.s.cylinder':'円柱(DB)','dg.line':'線','dg.l.solid':'実線','dg.l.dashed':'破線','dg.arrow':'矢印','dg.a.end':'終点','dg.a.both':'両方向','dg.a.none':'なし'
  }
};
(function(){
  var SUP = ['ko','en','zh','ja'];
