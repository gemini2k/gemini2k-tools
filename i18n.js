...
window.I18N = {
  ko: {
    ...
    'cat.PDF':'PDF',
    'pdf.note':'모든 처리는 브라우저에서 이루어지며, 파일은 서버로 전송되지 않습니다.','pdf.err':'처리 중 오류가 발생했습니다. 파일을 확인해 주세요.','pdf.processing':'처리 중…',
  ...
  en: {
    ...
    'cat.PDF':'PDF',
    'pdf.note':'All processing happens in your browser — files are never sent to a server.','pdf.err':'Something went wrong. Please check the file.','pdf.processing':'Processing…',
  ...
  zh: {
    ...
    'cat.PDF':'PDF',
    'pdf.note':'所有处理均在浏览器中完成，文件不会发送到服务器。','pdf.err':'处理出错，请检查文件。','pdf.processing':'处理中…',
  ...
  ja: {
    ...
    'cat.PDF':'PDF',
    'pdf.note':'すべての処理はブラウザ内で行われ、ファイルはサーバーに送信されません。','pdf.err':'処理中にエラーが発生しました。ファイルをご確認ください。','pdf.processing':'処理中…',
